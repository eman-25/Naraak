...
class PhcResearchScreen extends StatefulWidget {
  ...
  @override
  State<PhcResearchScreen> createState() => _PhcResearchScreenState();
}

class _PhcResearchScreenState extends State<PhcResearchScreen> {
  int _currentStep = 1;

  // Step 1: Applicant State
  String _selectedRole = 'Researcher'; // 'Researcher' or 'Student'
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Expanded(
                child: _buildRoleTab('Researcher'),
              ),
              Expanded(
                child: _buildRoleTab('Student'),
              ),
            ],
          ),
        ),
  ...
  Widget _buildStepperHeader() {
    return Row(
      children: [
        ...
        _buildStepItem(2, 'Research'),
        _buildStepLine(active: _currentStep >= 3),
        _buildStepItem(3, 'Documents'),
      ],
    );
  }
