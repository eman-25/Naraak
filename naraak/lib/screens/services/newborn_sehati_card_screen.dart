...
class NewbornSehatiCardScreen extends StatelessWidget {
  const NewbornSehatiCardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Sehati Card for Newborns')),
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Sehati Card for Newborns', style: AppTextStyles.h3, textAlign: TextAlign.center),
